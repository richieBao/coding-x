...
![VoxelNest CSV data](./img/voxelnest/voxelNest_27.png)
...
<YouTubeEmbed id="2IKMtmshhDw" />

**Modular Building - V1.1**



<YouTubeEmbed id="EzpKT7Dkhac" />
...
![VoxelNest CSV data](./img/voxelnest/voxelNest_26.png)

**Purpose:**
Convert selected Blueprint components or placed actors into standalone Static Mesh assets for optimization, reuse, archiving, or Nanite conversion in Unreal Engine.
...
**Benefit:**
Transforms modular Blueprint assemblies or placed building elements into **single StaticMesh assets**.
Greatly improves **performance**, **ease of reuse**, **LOD/Nanite workflows**, and supports **asset export pipelines** for large projects or procedural generation results.
...
![VoxelNest CSV data](./img/voxelnest/voxelNest_24.png)
